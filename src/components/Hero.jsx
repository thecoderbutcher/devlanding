    ...
    return ( 
        <div className='flex flex-col items-center mt-4 lg:mt-10'>
            ...
            <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>
                Empower your creativity and bring your VR app ideas to life with our intuitive development tools. Get started today and turn your imagination into inmersive reality!
            </p>
